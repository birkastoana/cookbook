...
ActiveRecord::Schema.define(version: 2020_01_28_130332) do
  ...
  create_table "recipes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.string "instructions", limit: 3000
    t.boolean "ok"
    t.bigint "recipe_ingredients_id"
    t.index ["recipe_ingredients_id"], name: "fk_rails_b6b93ed72d"
  end

  add_foreign_key "recipes", "recipe_ingredients", column: "recipe_ingredients_id"
end
